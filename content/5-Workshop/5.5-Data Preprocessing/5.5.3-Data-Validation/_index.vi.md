---
title: "Kiểm định dữ liệu thô (Raw Validation)"
date: 2024-01-01
weight: 3
chapter: false
pre: " <b> 5.5.3. </b> "
...
![Các file dữ liệu trong Amazon S3](../../../../images/5.3-data/5.3.3.1.png)
...
![Kết quả chạy chương trình kiểm định dữ liệu](../../../../images/5.3-data/5.3.3.2.png)
...
Sau khi hoàn thành bước kiểm định, dữ liệu đã sẵn sàng để chuyển sang **5.3.4 - Tiền xử lý và chuẩn hóa dữ liệu**.