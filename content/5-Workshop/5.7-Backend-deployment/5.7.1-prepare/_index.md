...
Only configure `SAGEMAKER_ENDPOINT_NAME` after the endpoint reaches the `InService` status and the request/response format has been finalized with the ML team.
