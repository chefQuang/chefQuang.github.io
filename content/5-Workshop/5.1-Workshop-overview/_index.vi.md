...
Workshop này mô tả cách nhóm xây dựng một hệ thống dự báo và cảnh báo chất lượng không khí cục bộ trên AWS theo hướng có thể demo lại bằng một luồng end-to-end rõ ràng.
